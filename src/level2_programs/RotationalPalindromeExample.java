...
public class RotationalPalindromeExample {
	...
	/**
	 * wrapper method which calls rotateString() method, until we have checked all
	 * possible rotations of String.
	 * 
	 * @param inputString
	...
	public static boolean isRotationalPaliondrome(String inputString) {
		...
		for (int x = 0; x < inputString.length(); x++) {
			...
			if (isPalindrome(ar)) {
				System.out.println(
						"inputString(i.e " + inputString + ") is rotation of the palindrome: " + String.valueOf(ar));
				return true;
			}
		}
		return false;
